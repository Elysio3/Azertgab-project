            ...
            <div class="grid-container">
                <div class="grid-x">
                    <div class="cell small-8 large-offset-2 text-center">
                        <!-- titre -->
                        <h3><b><u>Création de compte</u></b></h3>
                    </div>
                </div>
                ...
                <form action="./php/connexion.php" method="post" style="border: solid black 1px">
                    ...
                    <div class="grid-x">
                        <div class="cell small-4 large-offset-4">
                            <table>
                                <tr>
                                    <td>
                                        <img src="./images/login_mail_icon.png" style="height: 50px">
                                    </td>
                                    <td>
                                        <input type="text" name="email" id="email" style="height: 50px" placeholder="Adresse mail" required/></input>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="cell small-4 large-offset-4">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="password" name="password_validation" id="password_validation" style="height: 50px" placeholder="Validez le mot de passe" required/></input>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="grid-x">
                        <div class="cell small-2 large-offset-4 text-center">
                            <button class="button secondary hollow large-offset-4" type="submit">Valider</button>
                        </div>
                    ...
                    <div class="grid-x">
                        <div class="cell small-12 text-center">
                            <a class="warning" href="">Vous possédez déjà un compte ?</a>
                            <br><br>
